...
class TestTokenStore:
    def test_save_and_lookup(self, temp_dir):
        ...
        store.save(
            "user_1",
            TokenData(access_token="acc_xxx", refresh_token="ref_yyy", expires_at=9999999999),
        )
    ...
    def test_is_authorized(self, temp_dir):
        ...
        store.save("user_1", TokenData(access_token="x", refresh_token="y", expires_at=9999999999))
    ...
    def test_encryption_roundtrip(self, temp_dir):
        ...
        original = TokenData(
            access_token="very-secret", refresh_token="very-refresh", expires_at=9999999999
        )
